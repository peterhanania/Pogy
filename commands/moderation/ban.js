...
await member.ban({ reason: `${reason} / Responsible user: ${message.author.tag}` }).catch(err => message.channel.send ({ embeds: [new MessageEmbed().setColor(client.color.red).setDescription(`${client.emoji.fail} | An error occured: ${err}`)]}))
