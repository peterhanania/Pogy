...
module.exports = class extends Command {
    ...
    async run(message) {
      ...
      message.channel.send ({ embeds: [new MessageEmbed().setFooter(`Shard #${message.guild.shardID}`).setDescription(`\`\`\`${table.toString()}\`\`\``).setColor(message.guild.me.displayHexColor)]})
    }
};